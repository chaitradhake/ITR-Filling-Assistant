...
> ⚠️ This project is a work in progress, built incrementally in small daily chunks.
...
- [x] **Day 1** — Basic MERN project skeleton (`/client` React + Vite, `/server` Express) with a working health-check connection between them
- [ ] Day 2 — Standalone tax calculation module (Old vs New regime slab logic)
- [ ] Day 3 — Express API endpoint wrapping the tax calculator
- [ ] Day 4 — React form for manual salary/deduction entry, calling the API
- [ ] Day 5 — File upload endpoint (Multer)
- [ ] Day 6 — Gemini Vision API integration for Form 16 extraction
- [ ] Day 7 — End-to-end flow: upload → extract → editable review → calculate
- [ ] Day 8+ — UI polish, charts, error handling, deployment
