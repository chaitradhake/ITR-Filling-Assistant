...
`;
  ...
  return (
    <section className="py-3xl bg-surface-container-low/50">
      <div className="px-gutter max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg glass-card rounded-2xl p-lg md:p-xl shadow-xl">
          ...
          <form onSubmit={handleCalculate} noValidate className="lg:col-span-5 lg:border-r border-b lg:border-b-0 border-outline-variant/30 lg:pr-lg pb-lg lg:pb-0 flex flex-col justify-between">
            <div>
              <div className="mb-xl">
          ...
          <div className="lg:col-span-7 bg-surface-container rounded-2xl p-lg flex flex-col gap-lg">
            ...
            {results ? (
              <>
                ...
                <div className="bg-[#10B981] p-lg rounded-2xl text-white flex flex-col sm:flex-row gap-md justify-between items-start sm:items-center mt-auto">
                  <div>
