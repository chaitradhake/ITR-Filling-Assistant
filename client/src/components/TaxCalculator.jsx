...
export default function TaxCalculator() {
  // Input fields state initialized with reference defaults
  ...
  // Results state initialized with values matching default inputs
  const [results, setResults] = useState({
    oldRegime: { totalTax: 98280 },
    newRegime: { totalTax: 53040 },
    ...
    <section className="py-3xl bg-surface-container-low/50" id="calculator">
      <div className="px-gutter max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg glass-card rounded-2xl p-lg md:p-xl shadow-xl">
          ...
          <form onSubmit={handleCalculate} className="lg:col-span-5 border-r border-outline-variant/30 pr-lg flex flex-col justify-between">
            <div>
              <div className="mb-xl">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-primary text-on-primary py-4 rounded-xl font-headline-md text-body-lg shadow-lg shadow-primary/20 hover:shadow-xl transition-all active:scale-[0.98] mt-xl flex items-center justify-center gap-sm ${loading ? 'opacity-80 cursor-not-allowed' : ''}`}
            >
              {loading ? (
                <>
