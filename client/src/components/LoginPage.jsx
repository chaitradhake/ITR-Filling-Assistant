...
export default function LoginPage({ onSwitchToSignup, onLoginSuccess }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Transition to main page after a short delay for premium UX feel
      setTimeout(() => {
        onLoginSuccess();
      }, 1500);
      ...
      <section className="py-3xl bg-surface-container-low/50 min-h-[calc(100vh-4rem)] flex items-center">
        <div className="px-gutter max-w-md mx-auto w-full">
          <div className="glass-card rounded-2xl p-lg md:p-xl shadow-xl text-center flex flex-col items-center gap-md border border-outline-variant/30">
            ...
            <h2 className="font-headline-lg text-headline-lg text-on-surface">Login Successful!</h2>
      ...
      <div className="px-gutter max-w-md mx-auto w-full">
        <div className="glass-card rounded-2xl p-lg md:p-xl shadow-xl border border-outline-variant/30">
          <div className="text-center mb-xl">
            <h2 className="font-headline-lg text-headline-lg mb-xs text-on-surface">Welcome Back</h2>
            <p className="text-body-sm text-on-surface-variant">Log in to manage your tax preparation.</p>
          </div>
          ...
          <form onSubmit={handleLogin} noValidate className="space-y-lg">
            <div>
